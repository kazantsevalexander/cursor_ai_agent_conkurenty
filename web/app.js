...
const ui = {
    ...
    renderImageAnalysis(analysis) {
        const visualScorePercent = (analysis.visual_style_score / 10) * 100;
        const designScorePercent = (analysis.design_score || 0) / 10 * 100;
        ...
        return `
            ...
            <div class="result-block">
                ...
                <div class="score-display">
                    ...
                    <div class="score-bar">
                        <div class="score-fill" style="width: ${visualScorePercent}%"></div>
                    </div>
                </div>
                <p>${analysis.visual_style_analysis || ''}</p>
            </div>
            
            ${analysis.design_score !== undefined ? `
            <div class="result-block">
                <h3>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/>
                    ...
                    Оценка дизайна/архитектуры
                </h3>
                <div class="score-display">
                    <span class="score-value">${analysis.design_score}/10</span>
                    <div class="score-bar">
                        <div class="score-fill" style="width: ${designScorePercent}%"></div>
                    </div>
                </div>
            </div>
            ` : ''}
            ...
            <div class="result-block">
                ...
                <p>${analysis.animation_potential}</p>
            </div>
            ` : ''}
