...
class ImageAnalysis(BaseModel):
    ...
    design_score: int = Field(0, ge=0, le=10, description="Оценка дизайна/архитектуры (0-10)")
    animation_potential: str = Field("", description="Потенциал для анимации/визуализации")
    recommendations: List[str] = Field(default_factory=list, description="Рекомендации")
